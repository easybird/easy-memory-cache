...
describe('node-cache', function () {
    ...
    describe('get()', function () {
        ...
        it('should handle various types of cache keys', function () {
            var keys = [null, undefined, NaN, true, false, 0, 1, Number.POSITIVE_INFINITY, Number.NEGATIVE_INFINITY, '', 'a', [], {}, [1, 'a', false], {
                a: 1,
                b: 'a',
                c: false
            }, function () {
        ...
        it('should handle various types of cache values', function () {
            var values = [null, undefined, NaN, true, false, 0, 1, Number.POSITIVE_INFINITY, Number.NEGATIVE_INFINITY, '', 'a', [], {}, [1, 'a', false], {
                a: 1,
                b: 'a',
                c: false
            }, function () {
    ...
    describe('debug()', function () {
        it('should count cache hits when false', function () {
            cache.debug(false);
            cache.put('key', 'value');
            cache.get('key');
            expect(cache.hits()).to.equal(1);
        ...
        it('should count cache misses when false', function () {
            cache.debug(false);
            cache.put('key', 'value');
            cache.get('miss1');
            expect(cache.misses()).to.equal(1);
    ...
    describe('createCache()', function () {
        ...
        it('it should not conflict with global store', function () {
            var localCache = cache.createCache();
            cache.put('test', 123);
